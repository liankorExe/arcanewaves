<template>
    <div class="p-8 max-w-[95rem] mx-auto text-white">
        <h1 class="text-4xl md:text-5xl font-extrabold text-center uppercase tracking-widest mb-12 
                   text-transparent bg-gradient-to-r from-blue-500 via-blue-300 to-blue-500 bg-clip-text">
            DESCRIPTION
        </h1>

        <p class="text-lg md:text-lg leading-relaxed text-left bg-[rgba(255,255,255,0.02)] p-6 rounded-lg shadow-lg">
            Le monde de <span class="text-blue-300 font-semibold">Nytheria</span> est en ruines.  
            Jadis florissant, il est désormais écrasé sous la domination impitoyable de la  
